...
void MyGlWindow::test()
{
	...
	mover.particle->setPosition(0.f, 2.f, 0.f);
	mover.particle->setInverseMass(1.f / 200.f);
	mover.particle->setVelocity(cyclone::Vector3(0.f, 30.f, 40.f));
	mover.particle->setAcceleration(0.f, -20.f, 0.f);
	mover.particle->setDamping(0.999f);
}
